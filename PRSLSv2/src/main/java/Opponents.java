...
public class Opponents {
    ...
    Stuart - always loses
    Sheldon - always plays spock
    Howard - sticks to paper/rock/scissors
    Raj - plays p,r,s and spock
    Leonard - plays anything
    Penny - hidden character, only shows up if "random" is chosen, plays "nuke"
    "traveler" Wil Wheaton - only shows if random is picked, always wins
    */
